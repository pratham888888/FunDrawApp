...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mImageButtonCurrentPaint=ll_paint_colors[9] as ImageButton
       ...
       if(requestCode== GALLERY){
           try{
               if(data!!.data!=null){
                   ...
                   Toast.makeText(this@MainActivity,"Error in parsing image or it's corrupted.",
    ...
    private fun requestStoragePermission(){
        if(ActivityCompat.shouldShowRequestPermissionRationale(this,
            ...
            Toast.makeText(this,"need permission tp add a background",Toast.LENGTH_LONG).show()
        }
    ...
    private inner class BitmapAsyncTask(val mBitmap:Bitmap): AsyncTask<Any, Void, String>() {
        ...
        override fun doInBackground(vararg params: Any?): String {
            ...
            {   try {
                ...
                val f=File(externalCacheDir!!.absoluteFile.toString()+File.separator+"KidDrawingApp"+
